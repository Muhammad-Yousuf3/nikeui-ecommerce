  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="p-4 border-b border-gray-200 flex items-center">
        <Link href="../components/newandfeatured" className="mr-4 text-blue-500 hover:underline">
          &larr; Back
        </Link>
      ...
      <main className="p-4 flex flex-col md:justify-center md:flex-row  md:bg-gray-50">
        ...
        <Image src={product.image} alt={product.id} width='300' height='300' className= 'h-auto object-contain'></Image>
        </div>
